    ...
    if ($error === 0) {
		if ($img_size > 125000000) {
			...
			if (in_array($img_ex_lc, $allowed_exs)) {
                ...
                $desc  = $_POST['dsc'];
                $price = $_POST['price'];
				$sql="INSERT INTO drinks (name,dsc,price,image_url) VALUES ('$name','$desc','$price','$new_img_name');";
    ...
    <div class="container my-5">
        <form method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label>Name</label>
                <input type="text" class="form-control" placeholder="Drinks Name" name="name" autocomplete="off" value=""required>
            </div>
            <div class="form-group">
                <label>Desc</label>
