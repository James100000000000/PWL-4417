    ...
    if ($error === 0) {
		if ($img_size > 125000000) {
			...
			if (in_array($img_ex_lc, $allowed_exs)) {
                ...
                $sql="select * from food where id=$truid";
                $result= mysqli_query($conn,$sql);
                $row=mysqli_fetch_assoc($result);
                ...
                $desc  = $_POST['dsc'];
                $price = $_POST['price'];
				$sql="update food set name='$name', dsc='$desc', price='$price', image_url='$new_img_name' where id=$truid";;
    ...
    <div class="container my-5">
        <form method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label>Name</label>
                <input type="text" class="form-control" placeholder="Food Name" name="name" autocomplete="off" value="<?php echo $name ?>"required>
            </div>
            <div class="form-group">
                <label>Desc</label>
            ...
            <div class="form-group">
                ...
                <?php echo '<img src="../Foods/' . $image . '" alt="../assets/err.jpg" style="max-width: 200px;height: auto;text-align: center;padding: 15px;" >' ?>
            </div>
